...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	$result = $conn->query("SELECT count(*) as total from keluarga");//ambil dari database pake count + 1
	$data = mysql_fetch_assoc($result);
	$nomor_keluarga = $data['total'];
...
<html>
   ...
   <body>
      <div id="konten">
         <form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']);?>">
            ...
            <div id="tabel_keluarga" style="background-color: red;">
               ...
               <label>Pelatihan Keterampilan</label>:
               
               <select id="pelatihan_keterampilan" name="pelatihan_keterampilan">
               ...
               <select id="jumlah_angota_keluarga" name="jumlah_anggota_keluarga" onchange="input_anggota()">
                  <option>-Jumlah Anggota Keluarga-</option>
              ...
              <label>Biaya Semobako</label>:<input type="text" name="biaya_sembako" placeholder="Masukkan Biaya Semobako"></input><br>
               ...
               <label>Status Tanah Rumah</label>:
               
               <select id="status_tanah_rumah" name="status_tanah_rumah">
               ...
               <label>Minim Perabot</label>:
               
               <select id="minim_perabot" name="minim_perabot">
                  <option>-Minim Perabot-</option>
                  <option value="ya">Ya</option>
                  <option value="tidak">Tidak</option>
               </select><br>
               
               <label>Lampu Tempel</label>:
               
               <select id="lampu_tempel" name="lampu_tempel">
               ...
               <label>Mampu Menyekolahkan</label>:
               
               <select id="mammpu_menyekolahkan" name="mampu_menyekolahkan">
            ...
            <br><br>
             ...
             <div id="tabel_anggota" style="background-color: green;">
               ...
               <label>Status Kepemilikan Lahan Pertanian</label>:
               
               <select id="status_kepemilikan_lahan_pertanian" name="status_kepemilikan_lahan_pertanian">
               ...
               <label>Status Kepemilikan Ternak</label>:
               
               <select id="status_kepimilikan_ternak" name="status_kepimilikan_ternak">
               ...
               <label>Status Kepemilikan Lahan Ternak</label>:
               
               <select id="status_kepimilikan_lahan_ternak" name="status_kepimilikan_lahan_ternak">
                  <option>-Kepimilikan Ternak-</option>
                  <option value="milik">Milik</option>
                  <option value="sewa">Sewa</option>
                  <option value="pinjam">Pinjam</option>
               ...
               <label>Status Kepemilikan Lahan Perikanan</label>:
               
               <select id="status_kepimilikan_lahan_perikanan" name="status_kepimilikan_lahan_perikanan">
            ...
            <div id="tabel_laut" style="background-color: red;">
               <label>Jumlah Biota</label>:
               
               <select id="jumlah_biota" onChange="input_biota()">
                  <option>-pilih-</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
            ...
            <div id="tabel_pohon" style="background-color: green;">
               ...
               <select id="jumlah_pohon" onChange="input_pohon()">
                  <option>-pilih-</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
            ...
            <div id="tabel_tanaman" style="background-color: red;">
               ...
               <select id="jumlah_tanaman" onChange="input_tanaman()">
                  <option>-pilih-</option>
                  <option value="1">1</option>
                  <option value="2">2</option>
                  <option value="3">3</option>
            ...
            <div id="container-anggota"></div>

            <button>Masukkan Data</button>

         </form>
      </div>
      <div id="tempat-skript"></div>
   </body>
   <script type="text/javascript">
     ...
     isi.appendChild(document.createTextNode("Bentuk Olahan "+(i+1)+" "));
      var input = document.createElement("input");
      input.type = "text";
      input.name = "bentuk_olahan"+(i+1);
      isi.appendChild(input);
      isi.appendChild(document.createElement("br"));
   ...
   function input_anggota(){
      var jumlah = document.getElementById('jumlah_angota_keluarga').value;
                     
      for(var i = 1; i <= jumlah ; i++){
         document.getElementById('container-anggota').innerHTML +=                       
               '<label>Nama</label>:<input type="text" name="nama" placeholder="Masukkan Nama"></input><br>'+               
               '<label>Hubungan</label>:'+
               '<select id="hubungan" name="hubungan">'+
'                  <option value="">-Masukkan Hubungan-</option>'+
